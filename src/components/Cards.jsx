...
function Cards({ skip, onConfirm, isSelected }) {
    ...
    const borderClass = isSelected ? 'border-4 border-yellow-500' : 'border border-transparent';
    ...
    return (
        <>
            <div className="relative rounded-lg shadow p-4 bg-white dark:bg-zinc-900 transition-all duration-300 hover:shadow-xl hover:scale-[1.05]  cursor-pointer group" onClick={handleShow}>
                ...
                <div className="relative flex flex-col items-center p-4" >
                    <div className="relative mb-4 w-full h-60 rounded overflow-hidden">
                        <img src={image} alt={`${skip.size} Yard Skip`} className="w-full h-full object-cover" />
                    ...
                    <h3 className="text-lg font-semibold pt-3 dark:text-white">{skip.size} Yard Skip</h3>
                    {/* <p className="text-sm text-gray-600">{skip.hire_period_days} day hire period</p> */}
                    <p className="text-xl font-bold mt-2 mb-5 text-yellow-400">£{skip.price_before_vat}</p>
